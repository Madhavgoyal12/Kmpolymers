        ...
        <div className="container px-5 py-10 mx-auto">
          ...
          <div className="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              <p className=" tagline-text leading-relaxed text-justify text-center text-base">
                Our Products at KM POLYMERS are made with the best quality
                and highest grade of perfection. We make sure that we deliver what is best according 
                to the requirements of the client. Our Experience helps us to deliver the best of the
